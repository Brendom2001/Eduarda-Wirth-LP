...
export default function WhatsAppButton() {
  ...
  return (
    <m.a
      ...
      className="group hidden md:flex fixed bottom-6 right-6 z-40 w-14 h-14 bg-[#25D366] rounded-full shadow-[0_4px_24px_rgba(37,211,102,0.4)] items-center justify-center hover:bg-[#22c05c] transition-colors duration-300"
    >
