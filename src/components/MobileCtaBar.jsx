  ...
  return (
    ...
    >
      <a
        ...
        className="flex items-center justify-center gap-2.5 bg-brand-cta text-[#EAEAE5] font-dm font-medium text-sm rounded-full py-3.5 w-full hover:bg-brand-contrast transition-colors duration-300 min-h-[52px]"
      >
